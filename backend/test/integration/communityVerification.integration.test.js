...
const codesFilePath = path.join(__dirname, '../../data/communityVerificationCodes.json');
...
describe('Integration: Community Verification', () => {
  ...
  it('should verify community and mark registration code as used', async () => {
    ...
    const verifyRes = await leaderAgent.post('/api/community-verification/verify').send({
      communityId: String(community._id),
      registrationCode: code,
    });
